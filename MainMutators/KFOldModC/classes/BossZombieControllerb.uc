...
//
//-----------------------------------------------------------
class BossZombieControllerb extends KFMonsterController;
...
function FightEnemy(bool bCanCharge)
{
	...
	if ( !EnemyVisible() )
	{
        ...
        if( bAlreadyFoundEnemy || ZombieBossold(Pawn).SneakCount > 2 )
        {
...
Begin:
	...
	if( HidingSpots==None )
		ZombieBossold(Pawn).BeginHealing();
