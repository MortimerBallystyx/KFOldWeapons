...
defaultproperties
{
     ...
     FireModeClass(0)=Class'KFOldModC.KnifeFire'
     FireModeClass(1)=Class'KFOldModC.KnifeFireB'
     ...
     Priority=2
     GroupOffset=1
     PickupClass=Class'KFOldModC.KnifePickup'
     PlayerViewOffset=(X=4.000000,Y=5.500000,Z=-4.000000)
     PlayerViewPivot=(Pitch=400)
     BobDamping=6.000000
     AttachmentClass=Class'KFOldModC.KnifeAttachment'
