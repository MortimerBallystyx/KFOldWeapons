...
defaultproperties
{
     ...
     FireModeClass(0)=Class'KFOldModC.CrossbowFire'
     ...
     InventoryGroup=4
     GroupOffset=3
     PickupClass=Class'KFOldModC.CrossbowPickup'
     PlayerViewOffset=(X=15.000000,Y=16.000000,Z=-12.000000)
     BobDamping=6.000000
     AttachmentClass=Class'KFOldModC.CrossbowAttachment'
