...
class ZombieGoreFastold extends zombiegorefastBase;

#EXEC OBJ LOAD FILE=KFCharactermodelsoldC.ukx
...
State RunningState
{
    ...
    function RangedAttack(Actor A)
    {
    	...
    	else if ( CanAttack(A) )
    	{
    		bShotAnim = true;
    		SetAnimAction('Claw');
    		//PlaySound(sound'KFOldModSnd.Zed.Claw2s', SLOT_None); 
