...
// Frag Fire
//=============================================================================
class KFMODFragFire extends RocketFire;  //   AssaultGrenade
...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
    ...
    if (KFPRI != none)
    {
        if (KFPRI.ClientVeteranSkill == class'KFVetFirebug')
            g = Weapon.Spawn(class'KFMODNade', instigator,, Start, Dir);
