...
// FlameChucker
//=============================================================================
class KFMODFlameThrower extends KFWeapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=class'KFMODFlameBurstFire'
     ...
     InventoryGroup=4
     GroupOffset=2
     PickupClass=class'KFMODFlameThrowerPickup'
     PlayerViewOffset=(X=25.000000,Y=19.000000,Z=-20.000000)
     BobDamping=6.000000
     AttachmentClass=class'KFMODFlameThrowerAttachment'
