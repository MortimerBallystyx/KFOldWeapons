class KFMODCrossbow extends KFWeapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=class'KFMODCrossbowFire'
     ...
     InventoryGroup=4
     GroupOffset=3
     PickupClass=class'KFMODCrossbowPickup'
     PlayerViewOffset=(X=15.000000,Y=16.000000,Z=-12.000000)
     BobDamping=6.000000
     AttachmentClass=class'KFMODCrossbowAttachment'
