...
//=============================================================================
class KFMODSingle extends KFWeapon;
...
function bool HandlePickupQuery( pickup Item )
{
    ...
    {
        if ( KFHumanPawn(Owner) != none && !KFHumanPawn(Owner).CanCarry(class'KFMODDualies'.default.Weight) )
        {
...
{
    if (  Instigator.PendingWeapon != none && Instigator.PendingWeapon.class == class'KFMODDualies' )
    {
        bIsReloading = false;
    }
...
defaultproperties
{
     ...
     FireModeClass(0)=class'KFMODSingleFire'
     ...
     InventoryGroup=2
     GroupOffset=1
     PickupClass=class'KFMODSinglePickup'
     PlayerViewOffset=(X=20.000000,Y=25.000000,Z=-10.000000)
     BobDamping=6.000000
     AttachmentClass=class'KFMODSingleAttachment'
