...
// Winchester Fire
//=============================================================================
class KFMODWinchesterFire extends KFFire;
...
defaultproperties
{
     ...
     DamageType=class'KFMODDamTypeWinchester'
     DamageMin=140
     DamageMax=156
     ...
     FireLoopAnim=
     FireEndAnim=
     FireSound=Sound'KFOldModSnd.Weapon.WinchesterFire'
     NoAmmoSound=Sound'KF_RifleSnd.Rifle_DryFire'
     FireForce="ShockRifleFire"
     FireRate=1.100000
     AmmoClass=class'KFMODWinchesterAmmo'
     AmmoPerFire=1
