...
//=============================================================================
class KFMODShotgun extends KFWeaponShotgun;
...
defaultproperties
{
     ...
     FireModeClass(0)=class'KFMODShotgunFire'
     ...
     InventoryGroup=3
     GroupOffset=2
     PickupClass=class'KFMODShotgunPickup'
     PlayerViewOffset=(X=2.000000,Y=18.750000,Z=-7.500000)
     BobDamping=7.000000
     AttachmentClass=class'KFMODShotgunAttachment'
