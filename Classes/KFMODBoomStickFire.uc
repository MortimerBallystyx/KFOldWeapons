...
// BoomStick Dual Fire
//=============================================================================
class KFMODBoomStickFire extends KFShotgunFire;
...
defaultproperties
{
     ...
     FireAimedAnim="Fire"
     StereoFireSound=Sound'KFOldModSnd.Weapon.DBFire'
     ProjPerFire=10
     bWaitForRelease=true
     bAttachSmokeEmitter=true
     TransientSoundVolume=255.000000
     TransientSoundRadius=500.000000
     FireSound=Sound'KFOldModSnd.Weapon.DBFire'
     NoAmmoSound=Sound'KF_DoubleSGSnd.2Barrel_DryFire'
     FireRate=2.500000
     AmmoClass=class'KFMODDBShotgunAmmo'
     AmmoPerFire=2
     ...
     ProjectileClass=class'KFMODBoomStickBulletC'
