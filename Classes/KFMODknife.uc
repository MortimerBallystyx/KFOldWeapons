...
//=============================================================================
class KFMODKnife extends KFMeleeGun;
...
defaultproperties
{
     ...
     FireModeClass(0)=class'KFMODKnifeFire'
     FireModeClass(1)=class'KFMODKnifeFireB'
     ...
     Priority=2
     GroupOffset=1
     PickupClass=class'KFMODKnifePickup'
     PlayerViewOffset=(X=4.000000,Y=5.500000,Z=-4.000000)
     PlayerViewPivot=(Pitch=400)
     BobDamping=6.000000
     AttachmentClass=class'KFMODKnifeAttachment'
